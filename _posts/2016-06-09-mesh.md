...
last_update: 2016-06-09 09:43:08 -0500
comments: true
tags: [word embedding] 
---
## pre-processing
...
For these 23 words, 11 of them show up as one-word sentences.
...
The text is then used to form dictionary words and 
context words. 
...
different types. The root words set the tone or topic of the 
full sentence whereas the later words are qualifiers that
describe the situation. 

The dictionary words are the ones to get word embedding and we
choose the root words to be dictionary words. 
There are 107 of them.

The context words are basically raw features. 
The common way to pick them is to use the top 10% or 20% of the
words that occur frequently.
I don't think it works in this case. Let's see what are the top
30 qualifier words in this data set in Table 2.
