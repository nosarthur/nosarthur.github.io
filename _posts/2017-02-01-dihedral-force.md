...
$$ \nabla_a\cos\phi = \frac{\hat m \times\hat n \times \hat m \times \mathbf r_2}{|\mathbf r_1\times \mathbf r_2|} $$
...
Recall that $$(\hat m\times\hat n)\times\hat m$$ is the component of $$\hat n$$ perpendicular to $$\hat m$$.
...
$$ \nabla_d\cos\phi = \frac{\hat n \times\hat m \times \hat n \times \mathbf r_2}{|\mathbf r_2\times \mathbf r_3|} $$
